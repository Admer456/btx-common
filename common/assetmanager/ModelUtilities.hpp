...
namespace Assets
{
	namespace RenderData
	{
		...
		public:
			...
			void AddData( Vec2 v, VertexAttributeType attribute, VertexAttributeDataType dataType, bool normalised = false );
			void AddData( Vec3 v, VertexAttributeType attribute, VertexAttributeDataType dataType, bool normalised = false );
			void AddData( Vec4 v, VertexAttributeType attribute, VertexAttributeDataType dataType, bool normalised = false );
			void ClearData();
